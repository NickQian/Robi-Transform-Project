/*  uart0 api(on pi 3B please disable bluetooth firstly by using rasp-config)
    ----
    Licensed under BSD license.
    ----
    0.1 - 2016.9.16  init version for Raspberry 3B(bcm2837. Use /dev/ttyS0 instead of /dev/ttyAMA0) - by Nick Qian
    ----
*/
