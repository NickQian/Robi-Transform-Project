/*  header file
    ...
    ----
    0.2 - 2016.9.17   uart0 use POSIX interface now --- by Nick Qian
    0.1 - 2016.1.11   init version for Raspberry 2B(bcm2836)(rd/wr uart0 directly) ---by Nick Qian
    ----
*/

#ifndef _FATABASERVO_H_
  #define _FATABASERVO_H_
