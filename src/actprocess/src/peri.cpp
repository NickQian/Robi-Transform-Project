/*
    ...
    by Nick Qian
    ----
    0.2 - 2016.9.14   Found camera is disabled by this. on pi 3(bcm2837) uart now use OS driver. reserve this for further usage
    0.1 - 2015.12.20  init version for Raspberry 2B(bcm2836)
    ----
*/
